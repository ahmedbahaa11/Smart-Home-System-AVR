...
void EEPROM_voidSendDataByte ( u16 Copy_u16LocationAddress , u8 Copy_u8DataByte )
{
    ...
    I2C_u8StartCondition ();
    // Send the address packet
    I2C_u8SendSlaveAddressWithWrite (Local_Address);
    // send the rest 8 BITS of the location Adress
    I2C_u8SendDataByte ( (u8)(Copy_u16LocationAddress));
    // Send The Data Byte to the Memory Location
    I2C_u8SendDataByte (Copy_u8DataByte);
    // Send Stop Condition
...
u8 EEPROM_voidReadDataByte ( u16 Copy_u16LocationAddress )
{
    ...
    I2C_u8ReStartCondition();
    // Send the address packet with Read operation
    I2C_u8SendSlaveAddressWithRead(Local_Address);
